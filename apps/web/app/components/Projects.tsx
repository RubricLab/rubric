...
function Card({
	...
	return (
		<div className='flex gap-3 rounded-xl border-2 border-neutral-400 bg-neutral-200 p-10 text-black shadow-2xl sm:flex-row sm:items-center sm:gap-5'>
			...
			<div className='flex items-center justify-center sm:w-1/4'>
				<Link
					className='group h-fit rounded-md bg-neutral-200 p-5 text-inherit'
					href={href}>
...
export default function Projects() {
	return (
		<div className='flex min-h-screen flex-col items-center justify-center gap-20 bg-neutral-100 p-8'>
			<h1 className='text-black'>_featured projects</h1>
