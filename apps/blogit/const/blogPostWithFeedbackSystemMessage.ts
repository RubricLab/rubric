...
Sometimes the user will request a change that only applies to one part of the blog post such as the banner, the title or the body. In this case you will leave other parts of the blog post untouched. 
